...
public class Yunzhijia820sp1 extends HttpClient {
    ...
    public static void main(String[] args) {
        ...
        try {
            new Yunzhijia820sp1().accessWeiboUrlByGet(url, urlParamMap, bizDataOAuthInfo);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
...
//                    System.out.println("连接失败，请重试reconnectCount" + this.reconnectCount);
                    Yunzhijia820sp1 myHttpClient = new Yunzhijia820sp1();
