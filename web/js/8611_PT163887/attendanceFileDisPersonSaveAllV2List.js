shr.defineClass("shr.ats.AttendanceFileDisPersonSaveAllV2List",shr.ats.attendanceFileBatchMaintainBase, {
	initalizeDOM : function () {
		shr.ats.AttendanceFileDisPersonSaveAllV2List.superClass.initalizeDOM.call(this);
		var that = this;
		//隐藏精确搜索框
