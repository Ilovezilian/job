var uuidNow;
//变动规则假期js
shr.defineClass("shr.ats.atsPCRuleSetForHolMulitEdit", shr.ats.atsPCRuleSetMulitEdit, {
    changeTypeLabel:'',
    ...
    initalizeDOM : function () {
        var _self = this;
        shr.ats.atsPCRuleSetForHolMulitEdit.superClass.initalizeDOM.call(this);
    }
    ,
    showIsUsePartTimeFirst:function () {
        if (uuidNow==undefined){
            return
        }
        if (uuidNow.indexOf("uuid")==-1){
            uuidNow = 'uuid'+uuidNow;
        }
        var _self = this;
        var value=$("#isUsePartTimeJob"+ uuidNow).val();
        if (value==jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_27081404_i18n_8) {
    ...
    ,initPCRuleMultDom:function(){
        ...
        if(_self.getOperateState() == 'VIEW' && uuid !=''){
            ...
            if(res.atsPCRuleInfo.isSub){
                isSub=jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_20;
            }else{
                isSub=jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_8;
            }
            if(res.atsPCRuleInfo.ishand){
                receiveStr =  res.atsPCRuleInfo.ishand == 2 ? jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_27081404_i18n_2 : jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_26
            }else{
                if (shr.getUrlRequestParam("tab")==5) {
                    var position=res.atsPCRuleInfo.isUsePartTimeJobFirst==jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_27081404_i18n_5
                        ?jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_27081404_i18n_5
                        :jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_27081404_i18n_0;
                    receiveStr = receiveStr+jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_27081404_i18n_4
                        +res.atsPCRuleInfo.isUsePartTimeJob+'，';
                    if (res.atsPCRuleInfo.isUsePartTimeJob==jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_27081404_i18n_8){
                        receiveStr = receiveStr+jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_27081404_i18n_7
                            +position
                            +jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_27081404_i18n_6
                            +'，';
                    }
                }
                receiveStr += shr.formatMsg(jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_28, [_self.changeTypeLabel, res.atsPCRuleInfo["holidaypolicyset.name"]]);
            }
            var html = ''
                + '<h5>'
                + jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_24
                + '</h5>'
                ...
                + jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_21
                ...
                + jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_1
                + '">'
                + jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_1
                + '</div><div class="field-desc"></div></div>'
                + '<div class="field-ctrl flex-c">'
                ...
                + jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_16
                + '</span></div>'
                + '</div></div>'
                + '</div>';
//
            if(shr.getUrlRequestParam("tab")!='4' && shr.getUrlRequestParam("tab")!='7' && shr.getUrlRequestParam("tab")!='8'){
                html += ''
                    + '<h5>'
                    + jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_2
                    + '</h5>'
                    + '<div class="row-fluid row-block " id="">'
                    ...
                    + '</div>'
                    + '<h5>'
                    + jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_11
                    + '</h5>'
                    + '<div class="row-fluid row-block " id="">'
                    + '<div data-ctrlrole="labelContainer">'
                    + '<div class="col-lg-1">'
                ...
                if(shr.getUrlRequestParam("tab")!='7' && shr.getUrlRequestParam("tab")!='8'){
                    if(res.atsPCRuleInfo.isForbiden){
                        html += ''
                            ...
                            + '<div class="col-lg-6 field-ctrl">'
                            + '<span class="field_input" title='+shr.formatMsg(jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_14, [res.atsPCRuleInfo.forbidenDay])+'>'
                            + shr.formatMsg(jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_14, [res.atsPCRuleInfo.forbidenDay])
                            + '</span>'
                            + '</div>'
                            + '</div>'
                    }
            ...
            if(shr.getUrlRequestParam("tab")=='7' || shr.getUrlRequestParam("tab")=='8'){
                if(res.atsPCRuleInfo.enrollChangeType=='1' && shr.getUrlRequestParam("tab")=='7'){
                    receiveStr=jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_40;
                }else if(res.atsPCRuleInfo.enrollChangeType=='0' && shr.getUrlRequestParam("tab")=='7'){
                    receiveStr=jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_41;
                }else if(res.atsPCRuleInfo.enrollChangeType=='2' && shr.getUrlRequestParam("tab")=='7'){
                    receiveStr=jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_42;
                }else if(res.atsPCRuleInfo.enrollChangeType=='3' && shr.getUrlRequestParam("tab")=='7'){
                    receiveStr=jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_43;
                }
                if(res.atsPCRuleInfo.enrollChangeType=='1' && shr.getUrlRequestParam("tab")=='8'){
                    receiveStr=jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_44;
                }else if(res.atsPCRuleInfo.enrollChangeType=='0' && shr.getUrlRequestParam("tab")=='8'){
                    receiveStr=jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_45;
                }else if(res.atsPCRuleInfo.enrollChangeType=='2' && shr.getUrlRequestParam("tab")=='8'){
                    receiveStr=jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_46;
                }else if(res.atsPCRuleInfo.enrollChangeType=='3' && shr.getUrlRequestParam("tab")=='8'){
                    receiveStr=jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_47;
                }
                html += ''
                    + '<h5>'
                    + jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_11
            ...
            if (shr.getUrlRequestParam("tab")!="4" && shr.getUrlRequestParam("tab")!="7" && shr.getUrlRequestParam("tab")!="8") {
                html += '</br>'
                    ...
                    + '<div class="span2"><span class=""><h5>'
                    + jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_27081404_i18n_9
                    + '</h5></span></div>'
                    + '</div></div>'
                    + '</div>'
        ...
        if(_self.getOperateState() == 'EDIT' && uuid !=''){
            ...
            $("input[name='isHand"+uuid+"'][value=0]").change(function() {
                $("#holidayPolicySet"+uuid).attr("validate","{required:true}");
                $("#holidayPolicySet"+uuid).parent().parent().parent().addClass("required");

            });
            [1,2].forEach(function(item){
                $("input[name='isHand"+uuid+"'][value=" + item + "]").change(function() {
                    $("#holidayPolicySet"+uuid).attr("validate","");
                    $("#holidayPolicySet"+uuid).val('');
                    $("#holidayPolicySet"+uuid).parent().parent().parent().removeClass("required");
                });
            });
...
//				$("#changeOper"+uuid).attr("title",res.changeOper);
            ...
            grid_f7_json.subWidgetOptions = {
                title:jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_23,
                multiselect:true,
...
//				grid_f7_json.subWidgetName = 'specialPromptGrid';
            ...
            grid_f7_json.subWidgetName = 'shrPromptGrid';
            grid_f7_json.subWidgetOptions = {title:jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_12,
                uipk:"com.kingdee.eas.hr.ats.app.HolidayPolicySet.AvailableList.F7",query:"",filter:"",domain:"",multiselect:false, treeFilterConfig: '',permItemId:""};
            //grid_f7_json.readonly = '';
            grid_f7_json.validate = '{required:true}';
            grid_f7_json.value = {id:res.atsPCRuleInfo["holidaypolicyset.id"],name:res.atsPCRuleInfo["holidaypolicyset.name"]};
            grid_f7_json.subWidgetOptions.isHRBaseItem = true;
            grid_f7_json.subWidgetOptions.filterConfig = [{name:'isComUse',value:true,
                alias:jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_22,
                widgetType:'checkbox'}];
            ...
            $("input[name='holidayPolicySet']").shrPromptBox("setBizFilterFieldsValues",$("#hrOrgUnit_id").val());


            //$("#holidayPolicySet"+uuid+"_el").attr("value",res.atsPCRuleInfo["holidaypolicyset.id"]);
            //$("#holidayPolicySet"+uuid).attr("value",res.atsPCRuleInfo["holidaypolicyset.name"]);
            //$("#holidayPolicySet"+uuid).attr("title",res.atsPCRuleInfo["holidaypolicyset.id"]);
            if(res.atsPCRuleInfo.isSub){
            ...
            select_json = {
                ...
                readonly: "",
                value: res.atsPCRuleInfo.isUsePartTimeJobFirst==jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_27081404_i18n_5?"1":"0",
                onChange: null,
                validate: "",
                filter: ""
            };
            ...
            select_json = {
                ...
                readonly: "",
                value: res.atsPCRuleInfo.isUsePartTimeJob==jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_27081404_i18n_8?"1":"0",
        ...
        shr.doGet({
            ...
            success: function(response) {
                ...
                $("input[name='isHanduuid"+uuid+"'][value=0]").change(function() {
                    $("#holidayPolicySetuuid"+uuid).attr("validate","{required:true}");
                    $("#holidayPolicySetuuid"+uuid).parent().parent().parent().addClass("required");

                });
                [1,2].forEach(function(item){
                    $("input[name='isHanduuid"+uuid+"'][value=" + item +"]").change(function() {
                        $("#holidayPolicySetuuid"+uuid).attr("validate","");
                        $("#holidayPolicySetuuid"+uuid).val('');
                        $("#holidayPolicySetuuid"+uuid).parent().parent().parent().removeClass("required");
                    });
                });
                //变动操作
                ...
                //	grid_f7_json.subWidgetName = 'shrPromptGrid';
                //	grid_f7_json.subWidgetOptions = {title:"",uipk:"com.kingdee.eas.hr.ats.app.AttAdminOrgUnit.F7",query:"",filter:"",domain:"",multiselect:true};
                //	grid_f7_json.readonly = '';
                //	$("input[name='ruleOrgUnit']").shrPromptBox(grid_f7_json);
...
//		grid_f7_json.subWidgetName = 'specialPromptGrid';
                $("input[name='ruleOrgUnit']").shrPromptBox(grid_f7_json);
                $("input[name='ruleOrgUnit']").shrPromptBox("setBizFilterFieldsValues",$("#hrOrgUnit_id").val());
                //考勤制度holidayPolicySet
                grid_f7_json = null;
                //grid_f7_json = {id:"ruleOrgUnituuid"+uuidNum,name:"ruleOrgUnit"};
                grid_f7_json = {id:"holidayPolicySetuuid"+uuid,name:"holidayPolicySet"};
                grid_f7_json.subWidgetName = 'shrPromptGrid';
                grid_f7_json.subWidgetOptions = {title:jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_10,
                    uipk:"com.kingdee.eas.hr.ats.app.HolidayPolicySet.AvailableList.F7",query:"",filter:"",domain:"",multiselect:false, treeFilterConfig: '',permItemId:""};
                grid_f7_json.readonly = '';
                grid_f7_json.validate = '{required:true}';
                ...
                grid_f7_json.subWidgetName = 'shrPromptGrid';
                grid_f7_json.subWidgetOptions = {title:jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_0,
                ...
                $('#serviceAge_'+ruleDetail_num+' #serviceAge_add').unbind('click').bind('click',function(){
                    self.serviceAge_num = self.serviceAge_num + 1;
                ...
                select_json = {
                    id: "isUsePartTimeJobFirstuuid"+uuidNow,
                    readonly: "",
                    value: "0",
                    onChange: null,
                    validate: "",
                ...
                select_json.enumSource = 'com.kingdee.eas.hr.ats.IsUsePartTimeJobFirstEnum';
                $("#isUsePartTimeJobFirstuuid"+uuidNow).shrSelect(select_json);

                select_json = {
                    id: "isUsePartTimeJobuuid"+uuidNow,
                    readonly: "",
                    value: "0",
                    onChange: _self.showIsUsePartTimeFirst,
                    validate: "",
                ...
                select_json.enumSource = 'com.kingdee.eas.hr.ats.IsUsePartTimeJobEnum';
                $("#isUsePartTimeJobuuid"+uuidNow).shrSelect(select_json);
                $("#isUsePartTimeJobFirst"+uuid).shrSelect(select_json);
            }
        });
    ...
    ,addSetValueForAtsFileHtml:function(ruleDetail_num,condition_num){
        ...
        that.remoteCall({
            ...
            param:{handler:"com.kingdee.shr.ats.web.handler.HolidayRuleEditHandler","entityName":"com.kingdee.eas.hr.ats.app.AtsHolidayFile"},
            success:function(response){
                _treeNode = response;
                var tempArr = []
...
//				$(this).parents(".ui-promptBox-frame").next().replaceWith('<input id="prop_op" type="text" name="prop_op" class="search-input-length input-height"/>');
    ...
    ,getAddNewEntryHtml : function(uuid,ruleDetail_num){
        ...
        if(shr.getUrlRequestParam("tab")=='1'){
            receiveStr =jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_6;
        }else{
            receiveStr =jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_3;
        }
        var html =''
            + '<h5>'
            + jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_24
            ...
            +'<div class="field-label" title="'+_self.changeTypeLabel
            +jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_21 + '">'
            + _self.changeTypeLabel+jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_21
            + '</div><div class="field-desc"></div></div>'
            ...
            + jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_19
            + '"></div></div>'
            + '<div class="field-area flex-c field-basis1"><div class="label-ctrl flex-cc flex-r">'
            +'<div class="field-label" title="'+ jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_1 +'">'
            + jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_1
            + '</div><div class="field-desc"></div></div>'
            + '<div class="field-ctrl flex-c">'
        ...
        if(shr.getUrlRequestParam("tab")!='4'){
            html += ''
                ...
                + jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_17
                + '"></div>'
                + '</div>'
                + '<h5>'
                + jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_11
                ...
                + shr.formatMsg(jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_27, [_self.changeTypeLabel])
                + '</div>'
                + '</div></div>'

                + '<div class="row-fluid row-block">'
                + '<div class="row-fluid row-block">'
                + '<div class="col-lg-1" style="width: auto;margin-right: 10px;"><div style=" text-align: left;" class="field_label" title="'
                + jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_4
                + '">'
                + jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_4
                + '</div></div>'
                + '<div class="col-lg-2 field-ctrl"><input id="holidayPolicySetuuid'+uuid+'" name="holidayPolicySet" class="block-father input-height" type="text" validate="{required:true}" ctrlrole="promptBox" autocomplete="off" title="" placeholder="'
                + jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_18
                + '"></div>'
                // + '<div class="col-lg-1"><div style="text-align: center;padding-right: 0;" class="field_label" title="">、</div></div>'
                // + '<div class="col-lg-4 field-ctrl"><input id="atsShiftuuid'+uuid+'" name="atsShift" class="block-father input-height" type="text" validate="" ctrlrole="promptBox" autocomplete="off" title="" placeholder="请选择默认班次"></div>'
                + '<div class="col-lg-3"><div class="field_label" title="'
                + jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_7
                + '">'+receiveStr
                +jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_9
                + '</div></div></div>'
            if(shr.getUrlRequestParam("tab")==5){
                html 	 += '<div class="row-fluid row-block">'
                    + '<div class="col-lg-1" style="width: auto;margin-right: 20px; margin-top: 8px;"><div style=" text-align: left;" class="field_label" title="'
                    + jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_27081404_i18n_3
                    + '">'
                    + jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_27081404_i18n_3
                    + '</div><input id="isUsePartTimeJobuuid'+uuid+'" name="isUsePartTimeJob" class="block-father input-height" type="text" validate="{required:true}" ctrlrole="promptBox" autocomplete="off" title="" placeholder=""></div>'

                html 	 += '<div class="row-fluid row-block" style="display: none;">'
                    + '<div class="col-lg-1" style="width: auto;margin-right: 20px; margin-top: 8px;"><div style=" text-align: left;" class="field_label" title="'
                    + jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_27081404_i18n_1
                    + '">'
                    + jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_27081404_i18n_1
                    + '</div><input id="isUsePartTimeJobFirstuuid'+uuid+'" name="isUsePartTimeJobFirst" class="block-father input-height" type="text" validate="{required:true}" ctrlrole="promptBox" autocomplete="off" title="" placeholder="" ></div>'
                    + '</div>'
            }
            html += '</div>';
            if (shr.getUrlRequestParam("tab")!="4" && shr.getUrlRequestParam("tab")!="7" && shr.getUrlRequestParam("tab")!="8"){
            ...
            if(shr.getUrlRequestParam("tab")=='3'){
                html += '<div class="row-fluid row-block">'
                    ...
                    + '<div class="field_label" title="">'
                    + jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_27081404_i18n_2
                    + '</div>'
                    + '</div></div>';
            }
            ...
            html +='<div class="row-fluid row-block">'
                ...
                + '<div  class="field_label" title="">'
                + jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_25
                + '</div>'
                + '</div></div>';
        }else{
            html += ''
                ...
                + jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_13
                + '">'
                + shr.formatMsg(jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_14,[
                    '</div></div> '
                    + '</div>'
                    ...
                    + '</div>'
                    + '<div class="col-lg-2"><div class="field_label"  style="text-align: left;padding-left: 10px;" title="">'
                ])
                + '</div></div>'
                + '</div>';
        }
        if(shr.getUrlRequestParam("tab")=='7' || shr.getUrlRequestParam("tab")=='8'){
            ...
            if(shr.getUrlRequestParam("tab")=='7'){
                receiveStr0=jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_40 ;

                receiveStr1=jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_41 ;

                receiveStr2=jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_42 ;

                receiveStr3=jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_43 ;
            }
            if(shr.getUrlRequestParam("tab")=='8'){
                receiveStr0=jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_44 ;

                receiveStr1=jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_45 ;

                receiveStr2=jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_46 ;

                receiveStr3=jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_47 ;
            }
            var html =''
                + '<h5>'
                + jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_24
                + '</h5>'
                + '<div class="row-fluid row-block">'
                + '<div class="row-fluid row-block"><div class="col-lg-1 field-desc"></div>'
                + '<div class="col-lg-2"><div style=" text-align: left;" class="field_label" title=title="'+_self.changeTypeLabel
                +jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_21
                + '">'+jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_21+'</div></div>'
                + '<div class="col-lg-2 field-ctrl"><input id="ruleOrgUnituuid'+uuid+'" name="ruleOrgUnit" class="block-father input-height" validate="{required:true}" type="text" ctrlrole="promptBox" autocomplete="off" title="" placeholder="'
                + jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_19
                + '"></div></div>'
                + '<div class="row-fluid row-block"><div class="col-lg-1 field-desc"></div>'
                + '<div class="col-lg-2"><div class="field_label" title="'
                + jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_1
                + '">'
                + jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_1
                + '</div></div>'
                ...
                + '</h5>'
                + '<div class="row-fluid row-block">'
                + '<div class="row-fluid row-block flex-r" style="margin:10px;">'
                + '<div class="col-lg-2 field-desc"></div>'
                + '<input style="width:2%;" id="enrollChangeTypeuuid'+uuid+'" value="1" name="enrollChangeTypeuuid'+uuid+'" class="block-father input-height" type="radio" validate="" ctrlrole="promptBox" autocomplete="off" title="">'
                + '<div style="text-align: left;padding-left: 10px;width: 80%;" class="field_label" title="">'+receiveStr0+'</div></div>'

                + '<div class="row-fluid row-block flex-r" style="margin:10px;">'
                + '<div class="col-lg-2 field-desc"></div>'
                + '<input style="width:2%; id="enrollChangeTypeuuid'+uuid+'" value="0" name="enrollChangeTypeuuid'+uuid+'" class="block-father input-height" type="radio" validate="" ctrlrole="promptBox" autocomplete="off" title="">'
                + '<div style=" text-align: left;padding-left: 10px;width: 80%;" class="field_label" title="">'+receiveStr1+'</div></div>'


                + '<div class="row-fluid row-block flex-r" style="margin:10px;">'
                + '<div class="col-lg-2 field-desc"></div>'
                + '<input style="width:2%;" id="enrollChangeTypeuuid'+uuid+'" value="2" name="enrollChangeTypeuuid'+uuid+'" class="block-father input-height" type="radio" validate="" ctrlrole="promptBox" autocomplete="off" title="">'
                + '<div style=" text-align: left;padding-left: 10px;width: 80%;" class="field_label" title="">'+receiveStr2+'</div></div>'

                + '<div class="row-fluid row-block flex-r" style="margin:10px;">'
                + '<div class="col-lg-2 field-desc"></div>'
                + '<input style="width:2%;" id="enrollChangeTypeuuid'+uuid+'" value="3" name="enrollChangeTypeuuid'+uuid+'" class="block-father input-height" type="radio" validate="" ctrlrole="promptBox" autocomplete="off" title="">'
                + '<div style=" text-align: left;padding-left: 10px;width: 80%;" class="field_label" title="">'+receiveStr3+'</div></div>'
                + '</div></div>'
        }
        ...
        var  options = {};
        options.method='edit';
        options.uipk= 'com.kingdee.eas.hr.ats.app.AtsPCRuleSetForHol.form';
    ...
    enableAction : function() {
        ...
        shr.showConfirm(jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_15, function(){
            shr.ajax({
                type:"post",
                async:true,
                url:url,
                ...
                success:function(res){
                    shr.showInfo({message: jsBizMultLan.atsManager_atsPCRuleSetForHolMulitEdit_i18n_5, hideAfter: 3});
