...
shr.defineClass("shr.ats.HolidayLimitEdit", shr.framework.Edit, {
   initalizeDOM:function(){
		shr.ats.HolidayLimitEdit.superClass.initalizeDOM.call(this);
		var that = this ;
...
//	    	);
	    	...
	    	//重新计算剩余额度
	    	$('#remainLimit').val(
	    		(parseFloat(atsMlUtile.getFieldOriginalValue('realLimit'))-parseFloat(atsMlUtile.getFieldOriginalValue('usedLimit'))-parseFloat(atsMlUtile.getFieldOriginalValue('freezeLimit'))).toFixed(num)
	    	);
