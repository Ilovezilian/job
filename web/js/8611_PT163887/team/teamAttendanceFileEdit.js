shr.defineClass("shr.ats.team.TeamAttendanceFileEdit", shr.framework.Edit, {
	initalizeDOM:function(){
		shr.ats.team.TeamAttendanceFileEdit.superClass.initalizeDOM.call(this);
		var that = this;
		//that.initDeal();
...
//		} 
	...
	reloadPage:function(param, url){
		...
		shr.ats.team.TeamAttendanceFileEdit.superClass.reloadPage.call(this,param, url);
	}
   ...
   ,setButtonState: function() {
	...
	radioBoxInit:function(){
		if(shr.getCurrentViewPage().uipk !="com.kingdee.eas.hr.ats.app.team.AttendanceFileView.form"){
			return;
		}
		var that = this ;
		if (that.getOperateState().toUpperCase() != 'EDIT'){
