//组织长编码
var orgLongNum="";
shr.defineClass("shr.ats.team.TeamSignRecordList", shr.framework.List, {
	...
	initalizeDOM : function () {
		...
		shr.ats.team.TeamSignRecordList.superClass.initalizeDOM.call(this);
		//快速过滤展开
...
//	},
	...
	gridLoadComplete: function() {
        ...
        if(fID!="")
        {
        	var url = shr.getContextPath() + '/dynamic.do?handler=com.kingdee.shr.ats.web.handler.team.SignRecordListHandler&method=imageIsExsit&fID='+encodeURIComponent(fID);
        	shr.doAjax({
        		url:url,
	...
	queryGrid: function(){
		...
		if(dateRequiredValidate){
			shr.ats.team.TeamSignRecordList.superClass.queryGrid.call(this);
		}
	},
	//点击查询按钮执行的方法
...
function getImage(obj){
	  ...
	  var url = shr.getContextPath() + '/dynamic.do?handler=com.kingdee.shr.ats.web.handler.team.SignRecordListHandler&method=getImage&fID='+encodeURIComponent(fID);
