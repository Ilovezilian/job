shr.defineClass("shr.ats.team.TeamHolidayFileList", shr.ats.lackHolidayFileInfoEdit, {
	pageStep: 0,
    initalizeDOM:function(){
        shr.ats.team.TeamHolidayFileList.superClass.initalizeDOM.call(this);
		var that = this;
		that.initTabPages();
	...
	deleteAction:function(){	
		...
		if (selectedIds.length > 0) {
			...
			shr.ats.team.TeamHolidayFileList.superClass.deleteAction.call(this);
		}else{
			shr.showInfo({message: jsBizMultLan.atsManager_holidayFileList_i18n_20, hideAfter: 3});
			return;
		}
	...
	addBatchValAction : function(){
		var _self = this;
        var pageUipk="com.kingdee.eas.hr.ats.app.team.HolidayFile.list";
	...
	initTabPages: function(){
	    ...
	    $('#holidayFileList').click(function(){ 
			...
			that.changePageLabelColor();
			that.reloadPage({
                uipk: 'com.kingdee.eas.hr.ats.app.team.HolidayFile.list'
		    });	
		});
...
//			  uipk: 'com.kingdee.eas.hr.ats.app.HolidayFileDisPersonViewV2.list'
                uipk: 'com.kingdee.eas.hr.ats.app.team.NoHolidayFile.list'
		    });	
		});
	...
	,getPersonChangeTabNum : function(){
        ...
        var uipk = "com.kingdee.eas.hr.ats.app.team.NoHolidayFile.list";
