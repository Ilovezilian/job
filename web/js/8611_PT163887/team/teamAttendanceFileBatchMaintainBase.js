var isEdit=false;
shr.defineClass("shr.ats.team.TeamAttendanceFileBatchMaintainBase", shr.framework.List, {
	initalizeDOM:function(){
		$(this.gridId).jqGrid("option","rowNum",200);
		shr.ats.team.TeamAttendanceFileBatchMaintainBase.superClass.initalizeDOM.call(this);
		var self = this ;
	...
	onCellSelect:function(rowid,iCol,cellcontent,e){
		...
		if(iCol==5||iCol==7||iCol==8||iCol==9||iCol==10||iCol==11||iCol==12||iCol==13){
	...
	setSelectValueToGridCell: function(rowid,columnNum,cellcontent,e,ids){
		var _self = this ;
		var $table;
		if(columnNum == 10 || columnNum == 11||columnNum==7){
...
//		grid_f7_json.subWidgetOptions.bizFilterFields = "hrOrgUnit";
	...
	setDefaultShiftF7ToGridCell: function(rowid,columnNum,cellcontent,e){
		...
		grid_f7_json.subWidgetOptions = {
			...
			uipk:"com.kingdee.eas.hr.ats.app.team.AtsShift.AvailableList.F7",
			query:"",
			filter:"",
			domain:"",
			multiselect:false,
	...
	*/
	...
	appendDynamicHTML: function(object,pageUipk){
		...
		grid_f7_json.subWidgetName = 'shrPromptGrid';
		grid_f7_json.subWidgetOptions = {title:jsBizMultLan.atsManager_attendanceFileBatchMaintainBase_i18n_7,uipk:"com.kingdee.eas.hr.ats.app.team.AttencePolicy.AvailableList.F7",query:"",filter:"",domain:"",multiselect:false};
		grid_f7_json.readonly = '';
		grid_f7_json.validate = '';
			grid_f7_json.value = {id:"",name:""};
			grid_f7_json.subWidgetOptions.isHRBaseItem = true;
		...
		grid_f7_json.subWidgetName = 'shrPromptGrid';
		grid_f7_json.subWidgetOptions = {title:jsBizMultLan.atsManager_attendanceFileBatchMaintainBase_i18n_10,uipk:"com.kingdee.eas.hr.ats.app.team.AtsShift.AvailableList.F7",query:"",filter:"",domain:"",multiselect:false};
		grid_f7_json.readonly = '';
		grid_f7_json.validate = '';
			grid_f7_json.value = {id:"",name:""};
			grid_f7_json.subWidgetOptions.isHRBaseItem = true;
