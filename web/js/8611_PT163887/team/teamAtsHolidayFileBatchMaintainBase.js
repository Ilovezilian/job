shr.defineClass("shr.ats.team.TeamatsHolidayFileBatchMaintainBase", shr.framework.List, {
	initalizeDOM:function(){
		shr.ats.team.TeamatsHolidayFileBatchMaintainBase.superClass.initalizeDOM.call(this);
	},
	...
	setHolidayPolicySetF7ToGridCell: function(rowid,columnNum,cellcontent,e){
		...
		grid_f7_json.subWidgetOptions = {
			...
			uipk:"com.kingdee.eas.hr.ats.app.team.HolidayPolicySet.F7",
			query:"",filter:"",
			domain:"",
			multiselect:false,
			onclikFunction: function (ids) {
	...
	*/
	...
	appendDynamicHTML: function(object,pageUipk){
		...
		grid_f7_json.subWidgetOptions = {title:jsBizMultLan.atsManager_atsHolidayFileBatchMaintainBase_i18n_5,
				uipk:"com.kingdee.eas.hr.ats.app.team.HolidayPolicySet.F7",query:"",filter:"",domain:"",multiselect:false};
		grid_f7_json.subWidgetOptions.isHRBaseItem = true;
