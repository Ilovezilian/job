...
shr.defineClass("shr.ats.team.TeamFillSignCardEdit", shr.framework.Edit, {
      strdate:"",
      initalizeDOM:function(){
			shr.ats.team.TeamFillSignCardEdit.superClass.initalizeDOM.call(this);
			var that = this ;
...
//				}
	...
	/**
	 * 点击取消按钮 返回到专员补卡列表list(专员) ||  com.kingdee.eas.hr.ats.app.team.FillSignCard.list
	 */
	...
	,getCurrentModel : function(){
		...
		var that = this ;
		var model = shr.ats.team.TeamFillSignCardEdit.superClass.getCurrentModel.call(this);
