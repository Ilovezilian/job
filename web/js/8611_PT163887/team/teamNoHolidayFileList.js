shr.defineClass("shr.ats.team.TeamNoHolidayFileList", shr.framework.List, {
    pageStep: 1,
	initalizeDOM : function () {
		shr.ats.team.TeamNoHolidayFileList.superClass.initalizeDOM.call(this);
		var that = this;
		that.initTabPages();
		that.setNavigate();
	...
	addNewAction : function (event) {
		...
		that.remoteCall({
						...
						success:function(res){
							...
							that.reloadPage({uipk : 'com.kingdee.eas.hr.ats.app.team.HolidayFileDisPersonSaveAllV2.list'});
						}
		});	
	}, 
	viewAction: function() {
