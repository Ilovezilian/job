function WorkShiftStrategy() {
	...
	var _dayType = [$.attendmanageI18n.workShiftStrategy.dayType1,
	...
	var _arrangeByCopy = function(personNums,hrOrgUnit) {
		var url = shr.getContextPath() + '/dynamic.do?method=initalize&uipk=com.kingdee.eas.hr.ats.app.team.arrangeByCopyWorkShift.form';
	...
	var _arrangeByshift = function(personNums,hrOrgUnit) {
		...
		url += '&uipk=com.kingdee.eas.hr.ats.app.team.AtsShiftForTurnShift.list&hrOrgUnitObj=';
