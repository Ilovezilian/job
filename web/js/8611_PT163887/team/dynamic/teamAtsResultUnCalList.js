var thisObject;
shr.defineClass("shr.ats.team.TeamAtsResultUnCalList", shr.framework.List, {
	pageStep: 0,
	rowNumPerPage : 15,
	attendPeriodId: "",
	...
	initalizeDOM : function () {
		...
		shr.ats.team.TeamAtsResultUnCalList.superClass.initalizeDOM.call(_self);
...
//		shr.attenceCalCommon.initviewTransaction(this.dateSelectName);
	...
	initTabPages: function(){
		...
		$('#calAttendPersonList').click(function(){ 
			...
			if(serviceUrl && (serviceUrl == "com.kingdee.eas.hr.ats.app.team.AttendanceResult.dynamicList" || serviceUrl =="com.kingdee.eas.hr.ats.app.AttendanceResultUncalList")){
				that.reloadPage({
					uipk: serviceUrl
		    	});
			}else {
