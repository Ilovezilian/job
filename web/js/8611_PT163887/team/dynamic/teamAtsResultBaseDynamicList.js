...
var currentCalUrl = "com.kingdee.eas.hr.ats.app.team.AttendanceResult.dynamicList";//记录考勤计算当前访问的URL
shr.defineClass("shr.ats.team.TeamAtsResultBaseDynamicList", shr.framework.DynamicList, {
	pageStep: 0,
	//attendPeriodId : null,
	...
	initalizeDOM : function () {
		...
		shr.ats.team.TeamAtsResultBaseDynamicList.superClass.initalizeDOM.call(_self);
	...
	getPageState: function(){
		...
		return shr.ats.team.TeamAtsResultBaseDynamicList.superClass.getPageState.call(this);
	},
