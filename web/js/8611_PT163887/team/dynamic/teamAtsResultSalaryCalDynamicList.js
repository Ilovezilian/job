shr.defineClass("shr.ats.team.TeamAtsResultSalaryCalDynamicList", shr.ats.team.TeamAtsResultBaseDynamicList, {
	pageStep: 2,
	dateSelectName: "attendancePeriod",
	initalizeDOM : function () {
		var _self = this;
		shr.ats.team.TeamAtsResultSalaryCalDynamicList.superClass.initalizeDOM.call(_self);
	...
	queryGrid: function() {
		...
		if(attencePolicyRequired){
			...
			shr.ats.team.TeamAtsResultBaseDynamicList.superClass.queryGrid.call(this);
		}else {
			return;
		}
...
//		 var endDate = shr.attenceCalCommon.getFilterParamValues("attendancePeriod")["endDate"];
		...
		var url = shr.getContextPath() + "/dynamic.do?uipk=com.kingdee.eas.hr.ats.app.team.AttendanceResultSalary.dynamicList"
		 shr.remoteCall({
				type:"post", 
				async:true,
				url: url,
