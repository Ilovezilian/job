...
shr.defineClass("shr.ats.team.TeamScheduleShiftImportEdit", shr.framework.List, {
	initalizeDOM:function(){
		shr.ats.team.TeamScheduleShiftImportEdit.superClass.initalizeDOM.call(this);
		var that = this ;
		$("#form").css("width","100%");
		that.setProposerF7();
	...
	,setDefaultShift : function(hrOrgUnitId){
		...
		var url = shr.getContextPath() + "/dynamic.do?handler=com.kingdee.shr.ats.web.handler.team.TeamScheduleShiftImportEditHandler&method=getDefaultShift"
	...
	,addShiftDetail : function(){
		...
		object.bind("change", function(){
			...
			var url = shr.getContextPath() + "/dynamic.do?handler=com.kingdee.shr.ats.web.handler.team.TeamScheduleShiftImportEditHandler&method=getShiftItemsInfo";
			$.ajax({
				url: url,
				async:false,
				type:'post',
