...
(function (){
    ...
    UM.plugins['source'] = function (){
        ...
        var sourceEditor, content, formula;
        ...
        me.commands['source'] = {
            execCommand: function (){
                ...
                if (sourceMode) {
                    ...
                    // real content and formula content
                    content = root.toHtml(true);
                    formula = UM.formulaParser(root);

                    sourceEditor = createSourceEditor(me.body.parentNode);
                    sourceEditor.setContent(formula);
                    ...
                    var cont = content || '<p>' + (browser.ie ? '' : '<br/>')+'</p>';
