shr.defineClass("shr.ats.HolidayLimitList", shr.framework.List, {
	...
	initalizeDOM : function () {
		...
		shr.ats.HolidayLimitList.superClass.initalizeDOM.call(this);
	},
	queryGrid: function(){
		...
		if(dateRequiredValidate){
			shr.ats.HolidayLimitList.superClass.queryGrid.call(this);
		}
	}
...
//		    }
	...
	viewAction: function(billId, rowid) {
		if (this.uipk == "com.kingdee.eas.hr.ats.app.HolidayLimitPerself.list") {
			...
			shr.ats.HolidayLimitList.superClass.viewAction.call(this,billId, rowid);
		}		
	}
