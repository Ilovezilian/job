shr.defineClass("shr.ats.AttendanceFilePersonChangeList", shr.ats.FilePersonChangeList, {
    pageStep: 0,
    cache_key:"atsPersonChangeList_bill",
	initalizeDOM : function () {
		shr.ats.AttendanceFilePersonChangeList.superClass.initalizeDOM.call(this);
		var that = this;
		localStorage.removeItem(that.cache_key);
		$("[title='" + jsBizMultLan.atsManager_attendanceFilePersonChangeList_i18n_1 + "']").parent().remove();
	},
	createDialogDiv : function(){
		...
		importDiv.dialog({
				modal : false,
				title : jsBizMultLan.atsManager_attendanceFilePersonChangeList_i18n_0,
				width : 1320,
				minWidth : 1320,
				height : 505,
				minHeight : 505,
