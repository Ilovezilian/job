...
shr.defineClass("shr.ats.AttendanceFileHIS", shr.framework.MultiRow, {
	
	initalizeDOM:function(){
	
	   shr.ats.AttendanceFileHIS.superClass.initalizeDOM.call(this);
	   var that = this ;
...
//					$("#save"+next[0].id).hide();
				...
				if (next) {
					setTimeout(function(){
						...
						$("#attencePolicy"+uuid).shrPromptBox("option", {
							onchange : function(e, value) {
								var info = value.current;
