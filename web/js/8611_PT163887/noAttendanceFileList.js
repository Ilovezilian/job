shr.defineClass("shr.ats.NoAttendanceFileList", shr.framework.List,{
	pageStep: 1,
	initalizeDOM : function() {
		shr.ats.NoAttendanceFileList.superClass.initalizeDOM
				.call(this);
		var that = this;
		that.initTabPages();
		that.setNavigate();
	...
	addNewAction : function(event) {
		...
		that.remoteCall({
						...
						//	if(res.flag){
							that.reloadPage({uipk : 'com.kingdee.eas.hr.ats.app.AttendanceFileDisPersonSaveAllV2.list'});
						//	}
						//	else{
