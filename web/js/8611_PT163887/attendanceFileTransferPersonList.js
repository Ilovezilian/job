shr.defineClass("shr.ats.AttendanceFileTransferPersonList", shr.ats.FilePersonChangeList, {
    pageStep: 3,
    cache_key:"atsPersonChangeList_bill",
	initalizeDOM : function () {
		shr.ats.AttendanceFileTransferPersonList.superClass.initalizeDOM.call(this);
		var that = this;
		$("[title='" + jsBizMultLan.atsManager_attendanceFileTransferPersonList_i18n_1 + "']").parent().remove();
	},
	createDialogDiv : function(){
		...
		importDiv.dialog({
				modal : false,
				title : jsBizMultLan.atsManager_attendanceFileTransferPersonList_i18n_0,
				width : 1035,
				minWidth : 1035,
				height : 505,
				minHeight : 505,
