...
var allSubOrgIDs="";
var orgLongNum="";
shr.defineClass("shr.ats.PunchCardRecordList", shr.framework.List, {
	...
	initalizeDOM : function () {
		...
		shr.ats.PunchCardRecordList.superClass.initalizeDOM.call(this);
...
//		});
	...
	,importRecodeAction : function(){
				...
				var url = shr.getContextPath() + "/dynamic.do?handler=com.kingdee.shr.ats.web.handler.PunchCardRecordListHandler&method=importRecodes";
			    shr.ajax({
				dataType: "json",
				type:"post",
				async:false,
...
//			+ '<input id="adminOrgUnitCloud_longNumber" name="adminOrgUnit.longNumber" type="hidden" value="">'
		...
		grid_f7_json.subWidgetName = 'shrPromptGrid';
		grid_f7_json.subWidgetOptions = {title:jsBizMultLan.atsManager_punchCardRecordList_i18n_17,uipk:"com.kingdee.eas.hr.ats.app.ExistFileForAdmin.F7",query:"",filter:"",domain:"",multiselect:true};
		grid_f7_json.readonly = '';
		grid_f7_json.validate = '{required:true}';
