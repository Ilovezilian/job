shr.defineClass("shr.ats.holidayLimitDetailReLeaveList",  shr.framework.List, {
	 pageStep: 1,
	initalizeDOM : function () {
		shr.ats.holidayLimitDetailReLeaveList.superClass.initalizeDOM.call(this);
		var that = this;
		that.initTabPages();
   ...
   changePageLabelColor:function(){
		...
		shr.showConfirm(jsBizMultLan.atsManager_holidayLimitDetailReLeaveList_i18n_5, function(){
	    that.remoteCall({
				type:"post",
				...
				success:function(res){
					that.reloadGrid(); 
					shr.showInfo({message: jsBizMultLan.atsManager_holidayLimitDetailReLeaveList_i18n_6,hideAfter:5});
				}
		});
		});
