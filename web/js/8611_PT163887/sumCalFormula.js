...
var ue_tableConfig = [];
var _formulaType = 3,ATTENDANCEPROJIECT = jsBizMultLan.atsManager_sumCalFormula_i18n_33,
	HOLIDAYLIMITPROJECT = jsBizMultLan.atsManager_sumCalFormula_i18n_31;
...
shr.defineClass("shr.ats.CalFormula", shr.framework.Core, {
	...
	initalizeDOM : function(){
		...
		document.getElementById("downLoadGuide").innerHTML='<i class="icon-paper-clip" style="font-size: 18px;color: #5daff7;margin-right: 10px;"></i>'
			+ jsBizMultLan.atsManager_sumCalFormula_i18n_18;
		//获取设置公式类型 同步
		//this.getFormulaType();
		var html = [];
		html.push("<div id='formula-container' class='row-fluid'>");
		html.push("<div id='leftContainer'>");
		...
		html.push("<span class='span6'><span>"
			+ jsBizMultLan.atsManager_sumCalFormula_i18n_15
		...
		html.push("<span class='span3'><span>"
			+ jsBizMultLan.atsManager_sumCalFormula_i18n_70
		...
		html.push("<span class='span3' style='text-align: right;'><span>"
			+ jsBizMultLan.atsManager_sumCalFormula_i18n_9
		...
		html.push('<INPUT class="number-btn shrbtn shrbtn-primary" type="button" value="1" onclick="insertAtCaret(\'1\');" ID="Button1" NAME="Button1" style="margin: 1px;width: auto;">');
		html.push('<INPUT class="number-btn shrbtn shrbtn-primary" type="button" value="2" onclick="insertAtCaret(\'2\');" ID="Button2" NAME="Button2" style="margin: 1px;width: auto;">');
		html.push('<INPUT class="number-btn shrbtn shrbtn-primary" type="button" value="3" onclick="insertAtCaret(\'3\');" ID="Button3" NAME="Button3" style="margin: 1px;width: auto;">');
		html.push('<INPUT class="number-btn shrbtn shrbtn-primary" type="button" value="+" onclick="insertAtCaret(\'+\', null, true);" ID="Button4" NAME="Button4" style="margin: 1px 20px 1px 1px;width: auto;">');
		html.push('<INPUT class="number-btn shrbtn shrbtn-primary" type="button" value="=" onclick="insertAtCaret(\'=\', null, true);" ID="Button5" NAME="Button5" style="margin: 1px;width: auto;">');
		html.push('<INPUT class="twochar-btn shrbtn shrbtn-primary" type="button" value="<>" onclick="insertAtCaret(\'<>\', null, true);" ID="Button6" NAME="Button6" style="margin: 1px 20px 1px 1px;width: auto;">');
		html.push('<INPUT class="text-btn shrbtn shrbtn-primary" type="button" value="'
			+ jsBizMultLan.atsManager_sumCalFormula_i18n_56
			+ '" onclick="insertAtCaret(\''
			+ jsBizMultLan.atsManager_sumCalFormula_i18n_56
			+ '\', colors.LOGIC, true);" ID="Button7" NAME="Button7" style="margin: 1px;width: auto;">');
		html.push('<INPUT class="text-btn shrbtn shrbtn-primary" type="button" value="'
			+ jsBizMultLan.atsManager_sumCalFormula_i18n_43
			+ '" onclick="insertAtCaret(\''
			+ jsBizMultLan.atsManager_sumCalFormula_i18n_43
			+ '\', colors.LOGIC, true);" ID="Button8" NAME="Button8" style="margin: 1px;width: auto;">');
		html.push('<br>');
		html.push('<INPUT class="number-btn shrbtn shrbtn-primary" type="button" value="4" onclick="insertAtCaret(\'4\');" ID="Button9" NAME="Button9" style="margin: 1px;width: auto;">');
		html.push('<INPUT class="number-btn shrbtn shrbtn-primary" type="button" value="5" onclick="insertAtCaret(\'5\');" ID="Button10" NAME="Button10" style="margin: 1px;width: auto;">');
		html.push('<INPUT class="number-btn shrbtn shrbtn-primary" type="button" value="6" onclick="insertAtCaret(\'6\');" ID="Button11" NAME="Button11" style="margin: 1px;width: auto;">');
		html.push('<INPUT class="number-btn shrbtn shrbtn-primary" type="button" value="-" onclick="insertAtCaret(\'-\', null, true);" ID="Button12" NAME="Button12" style="margin: 1px 20px 1px 1px;width: auto;">');
		html.push('<INPUT class="number-btn shrbtn shrbtn-primary" type="button" value="<" onclick="insertAtCaret(\'<\', null, true);" ID="Button13" NAME="Button13" style="margin: 1px;width: auto;">');
		html.push('<INPUT class="number-btn shrbtn shrbtn-primary" type="button" value=">" onclick="insertAtCaret(\'>\', null, true);" ID="Button14" NAME="Button14" style="margin: 1px 20px 1px 1px;width: auto;">');
		html.push('<INPUT class="text-btn shrbtn shrbtn-primary" type="button" value="'
			+ jsBizMultLan.atsManager_sumCalFormula_i18n_66
			+ '" onclick="insertAtCaret(\''
			+ jsBizMultLan.atsManager_sumCalFormula_i18n_66
			+ '\', colors.LOGIC, true);" ID="Button15" NAME="Button15" style="margin: 1px;width: auto;">');
		html.push('<INPUT class="text-btn shrbtn shrbtn-primary" type="button" value="'
			+ jsBizMultLan.atsManager_sumCalFormula_i18n_47
			+ '" onclick="insertAtCaret(\''
			+ jsBizMultLan.atsManager_sumCalFormula_i18n_47
		...
		html.push('<INPUT class="text-btn shrbtn shrbtn-primary" type="button" value="'
			+ jsBizMultLan.atsManager_sumCalFormula_i18n_7
			+ '" onclick="insertAtCaret(\''
			+ jsBizMultLan.atsManager_sumCalFormula_i18n_7
			+ '\', colors.LOGIC, true);" ID="Button23" NAME="Button23" style="margin: 1px;width: auto;">');
		html.push('<INPUT class="text-btn shrbtn shrbtn-primary" type="button" value="'
			+ jsBizMultLan.atsManager_sumCalFormula_i18n_28
			+ '" onclick="insertAtCaret(\''
			+ jsBizMultLan.atsManager_sumCalFormula_i18n_28
		...
		html.push('<INPUT class="text-btn shrbtn shrbtn-primary" type="button" value="'
			+ jsBizMultLan.atsManager_sumCalFormula_i18n_14
		...
		html.push('<div>'
			+ jsBizMultLan.atsManager_sumCalFormula_i18n_20
			+ '</div>');
		...
		*/
		...
		window.onbeforeunload = function(){
			if (clz.unsave)
				return jsBizMultLan.atsManager_sumCalFormula_i18n_21;
		}
	...
	modifyAction : function(){
		...
		if (clz.canEdit == 1) {
			...
			shr.showError({
				message : jsBizMultLan.atsManager_sumCalFormula_i18n_63
			});
		}
	},
	...
	,initFormulaList : function(){
		...
		clz.remoteCall({
			...
			success : function(data){
				...
				if ($tab.size() == 0) {
					...
					$tab.jqGrid({
						...
						colNames : [
							...
							"trueId",
							jsBizMultLan.atsManager_sumCalFormula_i18n_15,
							jsBizMultLan.atsManager_sumCalFormula_i18n_17,
							jsBizMultLan.atsManager_sumCalFormula_i18n_2,
							jsBizMultLan.atsManager_sumCalFormula_i18n_70,
							jsBizMultLan.atsManager_sumCalFormula_i18n_19,
							jsBizMultLan.atsManager_sumCalFormula_i18n_41,
							jsBizMultLan.atsManager_sumCalFormula_i18n_9,
							jsBizMultLan.atsManager_sumCalFormula_i18n_34
						],
						colModel : [ {
							name : "id",
							hidden : true,
					...
					$tab.jqGrid("option", {
						ondblClickRow : function(rowid, iRow, iCol, e){
							...
							if ($("#sidebar").is(":hidden"))
								clz.modifyAction();
							if (clz.unsave && !confirm(jsBizMultLan.atsManager_sumCalFormula_i18n_22)) {
								return;
							}
							$("#name").val(data.name);
							...
							if (data.isCal.indexOf("/on.png") > -1 && data.isCal.indexOf("title=\""
								+ jsBizMultLan.atsManager_sumCalFormula_i18n_59
								+ "\"") > -1) {
				...
				// 填充数据
				for ( var i in datas) {
					if(jsBizMultLan.atsManager_sumCalFormula_i18n_13.toUpperCase() == datas[i].isCal.alias.toUpperCase()){
						isAllCal = false;
					}
					var d = {
						id : datas[i].id,
				...
				shr.setIframeHeight();
				var isCalImg = isAllCal ?  $('<img onclick="ctrlIsCalAll(0);" style="width: 35px;height: 25px;margin-left:20%" src="/shr/addon/attendmanage/web/resource/images/on.png">') : $('<img onclick="ctrlIsCalAll(1);" style="width: 35px;height: 25px;margin-left:20%" src="/shr/addon/attendmanage/web/resource/images/off.png">');
	...
	initSenior : function(){
		...
		html.push("<input type='radio' name='_senior' id='_var' val='1' /><label for='_var'>"
			+ jsBizMultLan.atsManager_sumCalFormula_i18n_4
			+ "</label>");
		html.push("<input type='radio' name='_senior' id='_temp' val='2' /><label for='_temp'>"
			+ jsBizMultLan.atsManager_sumCalFormula_i18n_36
			+ "</label>");
		html.push("</div>");
		...
		html.push("<div class='intro-text'>"
			+ jsBizMultLan.atsManager_sumCalFormula_i18n_39
			+ "</div>");
	...
	initSeniorTab : function(type){
		...
		if (!clz.initTab) {
			...
			$("#funcTab").jqGrid({
				...
				colNames : [ jsBizMultLan.atsManager_sumCalFormula_i18n_35,
					jsBizMultLan.atsManager_sumCalFormula_i18n_40,
					jsBizMultLan.atsManager_sumCalFormula_i18n_11,
					jsBizMultLan.atsManager_sumCalFormula_i18n_12,
					jsBizMultLan.atsManager_sumCalFormula_i18n_8,
					jsBizMultLan.atsManager_sumCalFormula_i18n_39
				],
				colModel : [ {
					name : "type"
			...
			$("#varTab").jqGrid({
				...
				multiselect : false,
				rownumbers : false,
				colNames : [ jsBizMultLan.atsManager_sumCalFormula_i18n_40,
					jsBizMultLan.atsManager_sumCalFormula_i18n_11,
					jsBizMultLan.atsManager_sumCalFormula_i18n_5,
					jsBizMultLan.atsManager_sumCalFormula_i18n_39
				],
				colModel : [ {
					name : "name",
	...
	saveFormula : function(isAdd, $btn){
		...
		if ($("#name").val() == "") {
			shr.showInfo({
				message : jsBizMultLan.atsManager_sumCalFormula_i18n_49,
				hideAfter : 3
			});
			return;
		} else if (ue.getContentTxt().trim() == "") {
			shr.showInfo({
				message : jsBizMultLan.atsManager_sumCalFormula_i18n_50,
				hideAfter : 3
			});
			return;
		} else if (atsMlUtile.getFieldOriginalValue("sortSn") == "") {
			shr.showInfo({
				message : jsBizMultLan.atsManager_sumCalFormula_i18n_51,
				hideAfter : 3
			});
			return;
		} else if (!regex.test(atsMlUtile.getFieldOriginalValue("sortSn"))) {
			shr.showInfo({
				message : jsBizMultLan.atsManager_sumCalFormula_i18n_71,
				hideAfter : 3
			});
			return;
		}
		...
		this.remoteCall({
			...
			success : function(data){
				...
				clz.initFormulaList();
				shr.showInfo({
					message : jsBizMultLan.atsManager_sumCalFormula_i18n_3
				});
			}
		});
		clz.unsave = false;
	...
	removeAction : function(){
		if (!$("#remove").hasClass("shrbtn-primary"))
			return;
		var clz = this;
		shr.showConfirm(jsBizMultLan.atsManager_sumCalFormula_i18n_54, function(){
			clz.remoteCall({
				...
				success : function(data){
					...
					clz.formulaId = "";
					shr.showInfo({
						message : jsBizMultLan.atsManager_sumCalFormula_i18n_57,
						hideAfter : 3
					});
				}
			});
	...
	checkAction: function(){
		...
		shr.ajax({
			...
			success:function(res){
				closeLoader();
				if(res.mess==jsBizMultLan.atsManager_sumCalFormula_i18n_32)
				{
					shr.showInfo({message : jsBizMultLan.atsManager_sumCalFormula_i18n_32});
				}else{
...
function execFormatter(cellValue, options){
	return "<img onclick='execFormula(\"" + options.rowId + "\");' style='width: 20px;height: 20px;' src='" + shr.getContextPath() + "/addon/compensation/web/images/calc.png' "
		+ "title="+jsBizMultLan.atsManager_sumCalFormula_i18n_41+" />";
}

function isCalFormatter(cellValue, options){
	
	if(jsBizMultLan.atsManager_sumCalFormula_i18n_59.toUpperCase() == cellValue.toUpperCase()){
	    return "<img onclick='ctrlIsCal(\"" + options.rowId + "\");' style='width: 35px;height: 25px;margin-left:20%' src='" + shr.getContextPath() + "/addon/attendmanage/web/resource/images/on.png' "
			+ "title="+jsBizMultLan.atsManager_sumCalFormula_i18n_59+" />";
	}else{
		return "<img onclick='ctrlIsCal(\"" + options.rowId + "\");' style='width: 35px;height: 25px;margin-left:20%' src='" + shr.getContextPath() + "/addon/attendmanage/web/resource/images/off.png' "
			+ "title="+jsBizMultLan.atsManager_sumCalFormula_i18n_13+" />";
	}
...
function ctrlIsCal(rowId){
	...
	var updateIsCal = "0";
	if(jsBizMultLan.atsManager_sumCalFormula_i18n_59.toUpperCase() == isCalText.toUpperCase()){
		updateIsCal = "0";
	}else if(jsBizMultLan.atsManager_sumCalFormula_i18n_13.toUpperCase() == isCalText.toUpperCase()){
		updateIsCal = "1";
	}else{
		updateIsCal = "0";
	}
...
function execFormula(rowid){
	...
	html += "<tr>";
	html += "<td class='label-td'>"
		+ jsBizMultLan.atsManager_sumCalFormula_i18n_58
		+ "</td>";
	html += "<td><input id='_calPerson' class='input-height required' type='text' style='width: 532px;' /></td>";
	html += "</tr>";
	html += "</table>";
	html += "<div class='title-border'>"
		+ jsBizMultLan.atsManager_sumCalFormula_i18n_33
		+ "</div>";
	html += "<table id='inputTab' class='dialog-edit-table'>";
	html += "</table>";
	html += "<div class='title-border'>"
		+ jsBizMultLan.atsManager_sumCalFormula_i18n_60
		+ "</div>";
	html += "<table id='infoTab' class='dialog-edit-table'>";
	html += "</table>";
	html += "<div class='title-border'>"
		+ jsBizMultLan.atsManager_sumCalFormula_i18n_29
		+ "</div>";
	html += "<table id='calTab' class='dialog-edit-table'>";
	html += "</table>";
	showDialog(null, jsBizMultLan.atsManager_sumCalFormula_i18n_16, html, [ {
		text : jsBizMultLan.atsManager_sumCalFormula_i18n_41,
		click : function(){
			shr.msgHideAll();
			// 验证录入项目输入
//			if (!$("#_calPerson").val()) {
...
//			}
			...
			if (!flag) {
				shr.showError({
					message : itemName + jsBizMultLan.atsManager_sumCalFormula_i18n_0
				});
				return;
			}
			//模拟考勤计算公式执行方法
			openLoader(null, jsBizMultLan.atsManager_sumCalFormula_i18n_69);
			var calData = [];
	...
	} ], 800, 500, jsBizMultLan.atsManager_sumCalFormula_i18n_23);
	...
	$("#_calPerson").shrPromptBox({
		...
		subWidgetOptions : {
			title : jsBizMultLan.atsManager_sumCalFormula_i18n_58,
			uipk : "com.kingdee.eas.hr.ats.app.ExistFileForAdmin.F7"
			//uipk : "com.kingdee.shr.compensation.app.CmpSchemePerson.F7",
			// com.kingdee.eas.basedata.person.app.Person.F7
			//com.kingdee.eas.hr.ats.app.AttendanceFileForCal.F7
			//filter : filter
		},
		onchange : function(event, data){
			...
			openLoader(null, jsBizMultLan.atsManager_sumCalFormula_i18n_68);
				...
				success : function(data){					
					...
					for ( var i in data.infoItems) {
						...
						if(infoset.match(/Gender/i)){							
							if(value == "1"){
								value = jsBizMultLan.atsManager_sumCalFormula_i18n_44;
							}else{
								value = jsBizMultLan.atsManager_sumCalFormula_i18n_45;
							}
						}
						html += "<td class='label-td'>" + name + "</td>";
						html += "<td><div infoset='" + infoset + "' value='"+data.infoItems[i].value+"'>" + value + "</div></td>";
						if ((parseInt(i) + 1) % 2 == 0)
							html += "</tr>";
					}
					//人事信息
	...
	if (!clz.hasCalPerson)
		shr.showInfo({
			message : jsBizMultLan.atsManager_sumCalFormula_i18n_61
		});
}
...
function execLimitFormula(rowid){
	...
	showDialog(null, jsBizMultLan.atsManager_sumCalFormula_i18n_16, html, [ {
		...
		click : function(){
			...
			if (!$("#_calPerson").val()) {
				shr.showError({
					message : jsBizMultLan.atsManager_sumCalFormula_i18n_52
				});
				return;
			}
			var regexFloat = /^-?\d+(\.\d+)?$/, flag = true, itemName = "";
...
function openSeniorWindow(isInit){
	showDialog("#seniorDialog", jsBizMultLan.atsManager_sumCalFormula_i18n_26, null, [ {
		text : jsBizMultLan.atsManager_sumCalFormula_i18n_53,
		click : function(){
			selectSeniorItem();
		}
	} ], 675, 600, null);
  ...
  var keys = _.keys(ue_tableConfig);
    ...
    content = content.replace(regex, function(match, index, text) {    	
    	if(index > 0) {
    		...
    		if(c && c != " " && c != "+" && c != "-" && c != "*" && c != "/" && c != "="
    			&& c != ">" && c != "<" && c != "(" && c != "\"" && c != "," && c != jsBizMultLan.atsManager_sumCalFormula_i18n_24
    			&& c != jsBizMultLan.atsManager_sumCalFormula_i18n_38
				&& c != jsBizMultLan.atsManager_sumCalFormula_i18n_37
				&& c != jsBizMultLan.atsManager_sumCalFormula_i18n_64
				&& c != jsBizMultLan.atsManager_sumCalFormula_i18n_48
				&& c != jsBizMultLan.atsManager_sumCalFormula_i18n_67){
    			return match;
    		} 
    		c = text.charAt(index + match.length);    		
    		if(c && c != " " && c != "+" && c != "-" && c != "*" && c != "/" && c != "="
    			&& c != ">" && c != "<" && c != ")" && c != "\"" && c != "," && c != jsBizMultLan.atsManager_sumCalFormula_i18n_55
    			&& c != jsBizMultLan.atsManager_sumCalFormula_i18n_42
				&& c != jsBizMultLan.atsManager_sumCalFormula_i18n_65
				&& c != jsBizMultLan.atsManager_sumCalFormula_i18n_46
				&& c != jsBizMultLan.atsManager_sumCalFormula_i18n_6
				&& c != jsBizMultLan.atsManager_sumCalFormula_i18n_27){
    			return match;
    		} 
    	}    	
...
function getTableConfigId(){
 ...
 function test(){                
 var reg = /\[(.*?)\]/gi;              
 var str = jsBizMultLan.atsManager_sumCalFormula_i18n_1;
 var tmp = str.match(reg);               
 if (tmp) {                   
 	for (var i = 0; i < tmp.length; i++) {       
 		alert(tmp[i]); // 保留中括号                  
