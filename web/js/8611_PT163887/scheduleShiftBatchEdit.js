shr.defineClass("shr.ats.ScheduleShiftBatchEdit", shr.framework.Edit, {
	attendDate : "",
	endDate : "",
	defaultShiftId : "",
	filter1 : "",
	...
	initalizeDOM:function(){
		shr.ats.ScheduleShiftBatchEdit.superClass.initalizeDOM.call(this);
		var that = this;
		that.initEditGrid();
		...
		$("#defaultShift").shrPromptBox("option", {
			onchange : function(e, value) {
				 if(that.attendDate == "" || that.attendDate.length < 1 || that.endDate == "" || that.endDate.length < 1){
			  	    if(shr.getUrlRequestParam("uipk") !="com.kingdee.eas.hr.ats.ScheduleShiftItemModify"){
